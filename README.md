...
If you would prefer to just execute the code without the fluff - I also compiled the notebook into a nifty script for you, which is listed as "Automatidata.py".
